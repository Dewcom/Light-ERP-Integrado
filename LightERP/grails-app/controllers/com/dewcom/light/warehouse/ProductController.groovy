...
import com.dewcom.light.rest.warehouse.UpdateProductRequest
...
class ProductController extends RestController{
    ...
    def create() {
        ...
        ResponseREST tmpResponse = new ResponseREST()
        Product tmpProduct
        ProductRequest restProduct = new ProductRequest(request.JSON.product)
        try {
    ...
    def update() {
        ...
        ResponseREST tmpResponse = new ResponseREST()
        UpdateProductRequest tmpProduct = new UpdateProductRequest(request.JSON)
        try {
            tmpProduct.validate()
